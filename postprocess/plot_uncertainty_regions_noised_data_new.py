...
uncertainty = '4e_2'
scheme = 'testg'
output_folder = '/home/giovanni/Desktop/LDNets/pprocess_images/uncertainty_'+str(uncertainty)+'_'+str(scheme)+'_50_new_alpha_gamma/'
...
for i in range(n_tests):
    if scheme == 'testg':
        folder_name_train = '/home/giovanni/Desktop/LDNets/neurons_4_364_synthetic_lay2_err_' + uncertainty + '_Testg_trial_' + str(i+1) + '_2/train/'
        folder_name_testg = '/home/giovanni/Desktop/LDNets/neurons_4_364_synthetic_lay2_err_' + uncertainty + '_Testg_trial_' + str(i+1) + '_2/testg/'
        folder_name_real_train  = '/home/giovanni/Desktop/LDNets/target_err_' + uncertainty + '_Testg/train/'
        folder_name_real_testg  =  '/home/giovanni/Desktop/LDNets/target_err_' + uncertainty + '_Testg/testg/'
        if uncertainty != '3e_2':
            folder_name_real_train  = folder_name_train 
            folder_name_real_testg  = folder_name_testg
    else:
        folder_name_train = '/home/giovanni/Desktop/LDNets/neurons_4_364_synthetic_lay2_TRAIN_err_' + uncertainty +'_trial' + str(i+1) + '0_2/train/'
        folder_name_testg = '/home/giovanni/Desktop/LDNets/neurons_4_364_synthetic_lay2_TRAIN_err_' + uncertainty + '_trial' + str(i+1) + '0_2/testg/'
        folder_name_real_train  = '/home/giovanni/Desktop/LDNets/target_err_' + uncertainty + '_Train/train/'
        folder_name_real_testg  =  '/home/giovanni/Desktop/LDNets/target_err_' + uncertainty + '_Train/testg/'
        if uncertainty != '3e_2':
            folder_name_train = '/home/giovanni/Desktop/LDNets/neurons_4_364_synthetic_lay2_TRAIN_err_' + uncertainty +'_trial' + str(i+1) + '_2/train/'
            folder_name_testg = '/home/giovanni/Desktop/LDNets/neurons_4_364_synthetic_lay2_TRAIN_err_' + uncertainty + '_trial' + str(i+1) + '_2/testg/'
            folder_name_real_train  = folder_name_train 
            folder_name_real_testg  = folder_name_testg
    ...
    #folder_name_real_testg  =  '/home/giovanni/Desktop/LDNets/target_err_' + uncertainty + '_Testg/testg/'
    if i == 0:
        S_real_train     = np.loadtxt(folder_name_real_train + 'S_real.txt')
        E_real_train     = np.loadtxt(folder_name_real_train + 'E_real.txt')
        I_real_train     = np.loadtxt(folder_name_real_train + 'I_real.txt')
        beta_real_train  = np.loadtxt(folder_name_real_train + 'beta_real.txt')
        cases_real_train = np.loadtxt(folder_name_real_train + 'cases_real.txt')
        
        S_real_testg    = np.loadtxt(folder_name_real_testg + 'S_real_testg.txt')
        E_real_testg    = np.loadtxt(folder_name_real_testg + 'E_real_testg.txt')
        I_real_testg    = np.loadtxt(folder_name_real_testg + 'I_real_testg.txt')
        beta_real_testg = np.loadtxt(folder_name_real_testg + 'beta_real_testg.txt')
    ...
    if np.any(np.isnan(np.loadtxt(folder_name_testg + 'S_rec_testg.txt'))):
        ...
        E_testg.append(np.loadtxt(folder_name_testg + 'E_rec_testg.txt'))    
...
if plot_susceptible_train:
    for i in range(S_real_train.shape[0]):
        ...
        plt.plot(t,S_real_train[i, :], '--', alpha = 0.6, color = color_real, label = 'Real points', linewidth=3)
...
if plot_exposed_train:
    for i in range(E_real_train.shape[0]):
        fig = plt.figure(figsize=(width_in_inches, height_in_inches), dpi=dpi)
        plt.plot(t,E_real_train[i, :], '--', alpha = 0.6, color = color_real, label = 'Real points', linewidth=3)
...
if plot_infected_train:
    for i in range(I_real_train.shape[0]):
        fig = plt.figure(figsize=(width_in_inches, height_in_inches), dpi=dpi)
        plt.plot(t,I_real_train[i, :], '--', alpha = 0.6, color = color_real, label = 'Real points', linewidth=3)
...
if plot_beta_train:
    for i in range(I_real_train.shape[0]):
        fig = plt.figure(figsize=(width_in_inches, height_in_inches), dpi=dpi)
        plt.plot(t,beta_real_train[i, :], '--', alpha = 0.6, color = color_real, label = 'Real points', linewidth=3)
...
if plot_susceptible_testg:
    for i in range(S_real_testg.shape[0]):
        fig = plt.figure(figsize=(width_in_inches, height_in_inches), dpi=dpi)
        plt.plot(t,S_real_testg[i, :], '--', alpha = 0.6, color = color_real, label = 'Real points', linewidth=3)
...
if plot_exposed_testg:
    for i in range(E_real_testg.shape[0]):
        fig = plt.figure(figsize=(width_in_inches, height_in_inches), dpi=dpi)
        plt.plot(t,E_real_testg[i, :], '--', alpha = 0.6, color = color_real, label = 'Real points', linewidth=3)
...
if plot_infected_testg:
    for i in range(I_real_testg.shape[0]):
        fig = plt.figure(figsize=(width_in_inches, height_in_inches), dpi=dpi)
        plt.plot(t,I_real_testg[i, :], '--', alpha = 0.6, color = color_real, label = 'Real points', linewidth=3)
...
if plot_beta_testg:
    for i in range(I_real_testg.shape[0]):
        fig = plt.figure(figsize=(width_in_inches, height_in_inches), dpi=dpi)
        plt.plot(t,beta_real_testg[i, :], '--', alpha = 0.6, color = color_real, label = 'Real points', linewidth=3)
