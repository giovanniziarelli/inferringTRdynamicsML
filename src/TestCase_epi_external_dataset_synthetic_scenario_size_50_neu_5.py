...
folder = 'neurons_' + str(neurons) + '_' + str(T_fin) + '_synthetic_lay' + str(layers) + '_err_'+err_name+'_size_'+size[trial-1] + '_trialsim_' + str(trial_sim) +'/'
...
num_epochs_Adam_train = 1000# good
