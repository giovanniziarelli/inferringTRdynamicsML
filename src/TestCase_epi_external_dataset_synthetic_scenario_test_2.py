...
folder = '/home/giovanni/Desktop/LDNets/neurons_' + str(neurons) + '_' + str(T_fin) + '_synthetic_lay' + str(layers) + '_err_5e_2_Testg_trial_'+str(trial)+'_2/'
...
os.system('cp /home/giovanni/Desktop/LDNets/src/TestCase_epi_external_dataset_synthetic_scenario_test_2.py ' + folder)
